...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in quote_pb2_grpc.py depends on'
...
def add_QuoteServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('quote.QuoteService', rpc_method_handlers)
...
class QuoteService(object):
    ...
    def GetQuote(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            quote__pb2.QuoteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
